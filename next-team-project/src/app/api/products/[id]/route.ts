...
export async function GET(_req: Request, ctx: unknown) {
  ...
  try {
    ...
    const result = await sql`SELECT * FROM products WHERE id = ${productId} LIMIT 1`;
...
export async function PUT(req: Request, ctx: unknown) {
  ...
  try {
    ...
    const userRes = await sql`SELECT name FROM users WHERE email = ${email} LIMIT 1`;
    ...
    if (category) {
      const catRes = await sql`SELECT 1 FROM products WHERE category = ${category} LIMIT 1`;
...
export async function DELETE(_req: Request, ctx: unknown) {
  ...
  try {
    ...
    const check = await sql`SELECT id FROM products WHERE id = ${productId} LIMIT 1`;
